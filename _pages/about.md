...
Alone we can do so little; together we can do so much. If you are interested in using satellite remotely sensed data (e.g. MODIS, VIIRS, etc.), data-driven models (e.g. panel data regression models, geographically weighted regression models, random forests, etc.), and process-driven models (e.g. GEOS-Chem), you are welcome to contact me for potential co-operation!
