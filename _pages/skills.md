...
- Models<br/>
  Proficient: Temporal/[Spatial](https://github.com/pysal) statistical models such as the panel data regression model and the (multi-scale) geographically (temporal) weighted regression model (GWR)<br/>
